...
class PatternManager:
    ...
    def create_fresh_prompt(self, project_name: str, analysis_target: Path, 
                           tracked_files: list, directory_structure: str,
                           git_info: dict) -> str:
        """
...
"""
    ...
    def create_update_prompt(self, existing_doc: str, changes_summary: str,
                            git_info: dict) -> str:
        """
